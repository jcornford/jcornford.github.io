...
The derivation of the closed form solution to regularised least squares for follows a similar route to minimising the residual sum of squares, which we went through
